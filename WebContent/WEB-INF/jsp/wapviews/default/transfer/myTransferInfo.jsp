      ...
      <div class="transfer-buy">
        <div class="loan">
          <div class="hd"><!-- ng-bind="loansimpleinfo.name" -->
            ...
            <!-- <a class="rig" ng-bind="transferInfo.loan_name">回收中</a> -->
          </div>
          <ul class="bd">
            <li><span class="name">债权价值：</span><span ng-bind="transferInfo.amount_moeny|number:2"></span>元</li>
        ...
        <div class="loan-repay">
          ...
          <div class="bd">
            ...
            <!-- <dl>
              <dt>第2/3期</dt>
              <dd><span class="name">待收本金</span><span ng-bind="168|number:2">168.33</span>元</dd>
              <dd><span class="name">实收本金</span><span ng-bind="168|number:2">168.33</span>元</dd>
              <dd><span class="name">实收利息</span><span ng-bind="168|number:2">168.33</span>元</dd>
              <dd><span class="name">预还款日</span><span ng-bind="transfer.next_repay_time|timestamp|date:'yyyy-MM-dd'"></span></dd>
            </dl> -->  
          </div>
        </div>
      </div> 
