    ...
    <div class="page-view">
      <div class="ui-form reset-form">
        <form role="form" w5c-form-validate="vm.validateOptions" novalidate name="validateForm">
          ...
          <div class="form-group">
            <input type="text" class="form-control" placeholder="请输入推荐人（如无推荐人可不填写）" name="referrer" ng-model="register2.referrer">
          </div>
          <div class="form-group form-agree">
            <label for="agree">注册即视为同意<a ng-click="look('reg')">《网站服务协议》</a></label>
          </div>
          <div class="form-group">
