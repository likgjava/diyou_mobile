...
<nav class="nav-top navbar-fixed-top">
          ...
          <li>
            <div class="item-content">
              ...
              <div class="item-input"  style="float: right;margin-right:35px;">
                  <span ng-bind="bountyData.Amount"></span><span ng-if="bountyData.Amount">元红包</span>
  ...
  <div class="page-content page-bounty" ng-if="loanbounty==''">
      ...
      <div class="fd1">
        <span class="bountytips">使用<span ng-bind="bountyData.Amount"></span>元<span ng-bind="bountyData.bountyType"></span></span>
