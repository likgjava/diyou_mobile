...
<div class="page page-scroll" ng-controller="listTenderCtrl">
    <div class="page-content">
      <!-- <div class="loan-nav">
        <a href="tender.html" class="col-xs-6 link active">投资列表</a>
        <a href="change.html" class="col-xs-6 link">债权转让</a>
      </div> -->
      <div class="loan-nav">
        ...
        <div class="loan-list">
          <a class="loan-item" href="/wap/loan/loaninfoview#?id={{borrow.id}}" ng-repeat="borrow in borrowList.items">
            <div class="loan-content">
              <div class="load-title"><img ng-src="{{borrow.pic}}" src="/wapassets/default/images/loantype/style3/{{borrow.category_id}}.png" width="24" height="24">{{borrow.name}}</div>
              <div class="col-xs-4">
              ...
              <div class="progbar" >
                ...
                <div class="prog-text t{{borrow.status}}" ng-if="borrow.progress==100 && borrow.category_id == 7 && borrow.status==3">{{borrow.status_name}}</div>
            ...
            <div class="loan-foot">
              <span class="com col-xs-8" ng-if="borrow.vouch_company_id == 0"><i class="iconfont">&#xe60f;</i>担保方：无</span>
