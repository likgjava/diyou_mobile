      ...
      <div class="transfer-buy">
        <div class="loan">
          ...
          <ul class="bd">
            ...
            <li><span class="name">借款期限：</span><font ng-bind="loan_info.period_name" ></font></li>
          </ul>
        </div> 
        <div class="look" ng-if="loan_info.status!='-2'&&loan_info.status!='-1'&&loan_info.status!='-6'&&loan_info.status!='-7'&&loan_info.status!='-3'&&loan_info.status!='-4'&&loan_info.status!='-5'&&loan_info.status!='-6'&&loan_info.status!='4'">查看<a ng-click="look('loan',tender_info.loan_id)">《借款协议》</a></div>
