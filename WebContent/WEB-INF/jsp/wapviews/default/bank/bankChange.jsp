...
<div class="page page-user" ng-controller="bankChangeCtrl">
      ...
      <div class="list-block">
        ...
        <li>
          <div class="item-content">
            ...
            <div class="col-xs-8 item-input">
              <input class="txt" type="text" name="oldBankid" placeholder="请输入原卡号" required="" ng-model="formData.now_account" format-bank>
            </div>
          </div>
        </li>
        </ul>
      ...
      <div class="list-block">
        ...
        <li>
          ...
          <div class="item-content">
            ...
            <div class="col-xs-8 item-input">
              <input class="txt" type="text" name="newBankid" placeholder="请输入新卡号" required="" ng-model="formData.account" ng-change="bankDetection()" format-bank>
            </div>
          </div>
        </li>
        <li>
          <div class="item-content">
            ...
            <div class="col-xs-8 item-input">
              <input class="txt" type="text" w5c-repeat="newBankid" name="checkNewBankid" placeholder="请确认新卡号" required="" ng-model="formData.confirm_account" format-bank>
            </div>
          </div>
        </li>
        <li>
  ...
  <div class="panel panel-bank">
    ...
    <div class="page-content">
       <div class="bank-list">
        <ul>
          <li class="item-content" ng-repeat="bank in banklist" ng-click="selectBank(bank.code,bank.name)">
            <div class="item-media"><img ng-src="{{bank.url}}"></div>
            <div class="item-title" ng-bind="bank.name"></div>
          </li>
        </ul>
      </div>
    </div>  
