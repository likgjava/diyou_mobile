...
<section ng-controller="loanContentCtrl">
      ...
      <div class="tender-view">
        <div class="loan">
            ...
            <div class="loan-foot">
              <c:if test="${!empty loan_info.vouch_company_info}">
              	<span class="com col-xs-8" ><i class="iconfont">&#xe60f;</i>担保方：<span ng-bind="loan_info.vouch_company_info"></span></span>
              </c:if>
            ...
            <dl>
              ...
              <dd ng-if="loan_info.status=='3'&&loan_info.category_type!=3">
                ...
                <div class="progbar" >
                  ...
                  <div class="prog-text t{{loan_info.status}}" ng-if="loan_info.progress<100 && loan_info.status=='3'">{{loan_info.progress|number:2}}%</div>
              ...
              <div class="bd">
                ...
                <div class="bd-item bd-list" ng-if="tender_list.length>0">
                  ...
                  <div class="row" ng-repeat="item in tender_list">
                    ...
                    <div class="col-xs-4 time" ng-bind="item.add_time|timestamp|date:'yyyy-MM-dd'">2015-06-03</div>
                  </div>
