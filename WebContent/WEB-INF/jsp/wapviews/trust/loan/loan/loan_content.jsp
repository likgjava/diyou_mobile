      ...
      <div class="tender-view">
        <div class="loan">
            <div class="loan-content loan-details">
              ...
              <div class="rate">
                ...
                <div class="b1" ng-if="loan_info.award_proportion>0||loan_info.additional_apr>0">
	                <span ng-if="loan_info.award_proportion>0" class="r2" >+{{loan_info.award_proportion|number:2}}%</span>
            ...
            <div class="loan-foot">
              <span class="com col-xs-8"  ng-if="loan_info.vouch_company_id > 0" ><i class="iconfont">&#xe60f;</i>担保方：<span ng-bind="loan_info.vouch_company_info"></span></span>
        ...
        <div class="loan-main">
          ...
          <div class="loan-tabs" id="loanTabs">
              ...
              <div class="bd">
                <!--项目详情-->
                <div class="bd-item loan-item-content on" ng-bind-html="loan_info.contents">
               ...
               <!-- <div class="bd-item bd-info" ng-if="loan_info.is_company!=1">
                    ...
                    <div class="ibox">
                      ...
                      <dl class="con">
                        ...
                        <dd><span class="name">公司性质</span><span class="val" ng-bind="member_info.industry_name ||'无'"></span></dd>
                ...
                <!-- <div class="bd-item bd-info" ng-if="loan_info.is_company==1">
                    <div class="ibox">
                      ...
                      <dl class="con">
                        ...
                        <dd><span class="name">所在地</span><span class="val" ng-bind="company_info.place ||'无'"></span></dd>
        ...
        <div class="loan-bid">
          ...
          <a ng-if="loan_info.progress!=100 && loan_info.status=='3' && member.self_loan != 1  && member.can_tender_new != -1" class="btn btn-blue btn-block" ng-click="tender()"><span ng-if="loan_info.category_type != 3">立即投资</span><span ng-if="loan_info.category_type == 3">立即认购</span></a>
          <a ng-if="loan_info.progress!=100 && loan_info.status=='3' && member.self_loan == 1" class="btn btn-blue btn-block" ng-click="alert('请不要投资自己的借款标')"><span ng-if="loan_info.category_type != 3">立即投资</span><span ng-if="loan_info.category_type == 3">立即认购</span></a>
           <a ng-if="loan_info.progress!=100 && loan_info.status=='3' && member.self_loan != 1 && member.can_tender_new == -1" class="btn btn-blue btn-block" ng-click="alert('不是新手无法对新手标进行投标')"><span ng-if="loan_info.category_type != 3">立即投资</span><span ng-if="loan_info.category_type == 3">立即认购</span></a>
        </div>
      </div>
      <!-- 加载状态 -->
