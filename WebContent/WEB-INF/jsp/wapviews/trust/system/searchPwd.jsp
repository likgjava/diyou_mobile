    ...
    <div class="ui-form reset-form">
        <form role="form" w5c-form-validate="vm.validateOptions" novalidate name="validateForm">
          <div class="form-group">
            ...
            <input type="phone" name="phone" placeholder="请输入手机号" class="form-control" ng-model="search.account" required="" ng-pattern="/^(?:13\d|14\d|15\d|17\d|18\d)\d{5}(\d{3}|\*{3})$/" ng-if="search.type=='phone'">
            <input type="email" name="email" placeholder="请输入邮箱地址" class="form-control" ng-model="search.account" required="" ng-if="search.type=='email'">
          </div>
          <div class="form-group">
