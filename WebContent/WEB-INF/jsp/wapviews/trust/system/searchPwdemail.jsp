...
<section ng-cloak class="page" ng-controller="searchPwdemailCtrl" >
      ...
      <form role="form" w5c-form-validate="vm.validateOptions" novalidate name="validateForm">
        <div class="form-group">
          <div class="form-group-code">
            <input type="text" class="form-control" placeholder="请输入您的验证码" ng-model="search.emailCode" required="" name="phoneCode">
          </div>
          <a class="btn btn-blue btn-code" ng-bind="getCodeVal" ng-click="getEmailCode()" ng-disabled="isSend"></a>
        </div>
        <div class="form-group">
