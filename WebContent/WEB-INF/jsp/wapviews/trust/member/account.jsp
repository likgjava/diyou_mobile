...
<!--         <li class="fn-clear">
          <i class="icon i3"></i>
          <span class="name">已收奖励</span>
          <span class="val" ng-bind="account.award_total|number:2"></span>
          <span class="unit">元</span>
        </li> -->
        <li class="fn-clear">
          <i class="icon i4"></i>
    ...
    <div class="loginbar navbar-fixed-bottom">
      <!-- <a class="btn on" ng-click="pcNotice()">充值</a>
      <a class="btn on" ng-click="pcNotice()" >提现</a> -->
      <a class="btn on" ng-click="recharge()">充值</a>
