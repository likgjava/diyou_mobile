...
<section class="page page-cash" ng-controller="cashCtrl">
    <div class="page-content">
        <div class="list-block">
          ...
          <li>
            <div class="item-content item-bank">
              ...
              <div class="number" ng-bind="bankinfo.account2Wap"></div>
            </div>
          </li>
          <li>
        ...
        <div class="page-view">  
          ...
          <!-- 立即转让/转让详情 -->
          <input type="button" ng-disabled="disabled" class="btn btn-block btn-lg btn-blue" value="提现" ng-click="cashSubmit()" >
        </div>
