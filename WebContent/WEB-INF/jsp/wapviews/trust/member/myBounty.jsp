...
<div class="page">
  <div class="page-content page-bounty" ng-controller="mybountyCtrl">
    <ul>
       <li ng-repeat="bounty in bountyData.items" ng-class="{'undefalut':bounty.red_status!='已过期'&&bounty.red_status!='已使用','defalut':bounty.red_status=='已使用','used':bounty.red_status=='已过期', 'freeze': bounty.red_status=='已冻结'}" >
          <div class="lileft">
            <div class="letop">
              <span class="dw">￥</span>
          ...
          <div class="liright">
            ...
            <div class="toptime" ng-if="bounty.end_time != bounty.add_time"><span ng-bind="bounty.end_time|timestamp|date:'yyyy-MM-dd HH:mm:ss'"></span>到期</div>
          </div>
       </li>
    </ul>
    <div class="page-view">
