    ...
    <div class="list-block">
      ...
      <%--/wap/member/center --%>
        <a href="javascript:void(0);" class="item-content">
          <div class="col-xs-6 item-title "><i class="icon icon-user"></i>用户信息</div>
          <div class="col-xs-6 item-value" ng-bind="account.member_name"></div>
          <%-- 
      ...
      <li>
        <a class="item-content" ng-href="/wap/bank/index">
          <div class="col-xs-6 item-title"><i class="icon icon-bank"></i>银行卡管理</div>
          <div class="col-xs-6 item-value">
            <span ng-bind="account.bankName"></span>
            <span ng-bind="account.account2Wap"></span>
          </div>
          <i class="item-arrow iconfont">&#xe614;</i>
        </a>
      </li>
     <!--  <li>
        <a ng-click="pcNotice()" class="item-content">
          <div class="col-xs-6 item-title"><i class="icon icon-cust"></i>资产信息</div>
          <div class="col-xs-6 item-value g9">查看</div>
          <i class="item-arrow iconfont">&#xe614;</i>
        </a>
      </li> -->
      <li>
        <a class="item-content" ng-click="openTrust()" ng-if="account.trust_account.name==''">
          <div class="col-xs-6 item-title"><i class="icon icon-cust"></i>我的支付账号</div>
          <div class="col-xs-6 item-value g9">未注册</div>
          <i class="item-arrow iconfont">&#xe614;</i>
        </a>
        <a class="item-content" ng-href="/wap/trust/myTrust" ng-if="account.trust_account.name!=''">
          <div class="col-xs-6 item-title"><i class="icon icon-cust"></i>我的支付账号</div>
          <div class="col-xs-6 item-value g9" ng-bind="account.trust_account.name"></div>
          <i class="item-arrow iconfont">&#xe614;</i>
        </a>
      </li>
      </ul>          
    ...
    <div class="list-block">
      ...
      <li>
        <a ng-href="{{account.is_phone.url}}" class="item-content">
          ...
          <div class="col-xs-7 item-value g9" ng-bind="account.is_phone.name"></div>
          <i class="item-arrow iconfont">&#xe614;</i>
        </a>
      </li>
      <li>
        <a ng-href="{{account.is_email.url}}" class="item-content">
          ...
          <div class="col-xs-7 item-value g9" ng-bind="account.is_email.name"></div>
          <i class="item-arrow iconfont">&#xe614;</i>
        </a>
      </li>
      <li>
      ...
      <li>
        <a ng-click="pcNotice()" class="item-content">
          ...
          <div class="col-xs-7 item-value c-blue">查看</div>
          <i class="item-arrow iconfont">&#xe614;</i>
        </a>
      </li> --%>
      </ul>          
